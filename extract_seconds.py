...
def get_start_time(line_iterable, year):
    ...
    for line in line_iterable:
        ...
        if line.find('Solving') != -1:
            # Replace "solving" with "iteration 0".Because in the "solving" line, there is not start time recording.
...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        ...
        # exit(1)
        # sys.argv[1]= 'log_data.log'
        # sys.argv[2] = 'save.png'
    # extract_seconds('/home/shiw/Downloads/Person_search_CVPR17/person_search/my_example/log_data.log',
    #                 '/home/shiw/Downloads/Person_search_CVPR17/person_search/my_example/save.png')
